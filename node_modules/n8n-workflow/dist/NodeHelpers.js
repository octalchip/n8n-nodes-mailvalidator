...
function getVersionedNodeTypeAll(object) {
    if ('nodeVersions' in object) {
        return (0, uniqBy_1.default)(Object.values(object.nodeVersions)
            .map((element) => {
...
function getCredentialsForNode(object) {
    var _a;
    if ('nodeVersions' in object) {
        return (0, uniqBy_1.default)(Object.values(object.nodeVersions).flatMap((version) => { var _a; return (_a = version.description.credentials) !== null && _a !== void 0 ? _a : []; }), 'name');
    }
    return (_a = object.description.credentials) !== null && _a !== void 0 ? _a : [];
}
exports.getCredentialsForNode = getCredentialsForNode;
