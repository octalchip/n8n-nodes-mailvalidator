...
export async function googleApiRequest(
	...
	} else if ((credentials as any).oauthTokenData?.access_token) {
		accessToken = (credentials as any).oauthTokenData.access_token;
	} else if ((credentials as any).token) {
		accessToken = (credentials as any).token;
	} else if ((credentials as any).accessToken) {
